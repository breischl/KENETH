...
/**
 * Parameters to publish to a peer during energy coordination.
 *
 ...
 * A field that is non-null on the first tick must remain non-null for the lifetime of publishing.
 * Dropping a field mid-session causes the remote peer to stop receiving that message type and will
